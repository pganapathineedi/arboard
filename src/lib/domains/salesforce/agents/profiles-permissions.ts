...
const _raw = fs.readFileSync(
  path.join(process.cwd(), "src/prompts/agents/sf-profiles-permissions.md"),
  "utf-8"
);
...
export const profilesPermissionsAgent: AgentConfig = createBaseAgent({
  maxTokens: SPECIALIST_MAX_TOKENS,
  id: "sf-profiles-permissions",
  name: "Profiles & Permissions Specialist",
  role: "Profiles & Permissions Specialist",
  sections: {
    persona: _sec("Role"),
