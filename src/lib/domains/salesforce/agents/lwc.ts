...
const _raw = fs.readFileSync(path.join(process.cwd(), "src/prompts/agents/sf-lwc.md"), "utf-8");
...
export const lwcAgent: AgentConfig = createBaseAgent({ maxTokens: SPECIALIST_MAX_TOKENS,
  id: "sf-lwc",
