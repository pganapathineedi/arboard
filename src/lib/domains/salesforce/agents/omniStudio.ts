...
const _raw = fs.readFileSync(path.join(process.cwd(), "src/prompts/agents/sf-omni.md"), "utf-8");
...
export const omniStudioAgent: AgentConfig = createBaseAgent({ maxTokens: SPECIALIST_MAX_TOKENS,
  id: "sf-omni",
