...
const _raw = fs.readFileSync(path.join(process.cwd(), "src/prompts/agents/sf-agentforce.md"), "utf-8");
...
export const agentforceAgent: AgentConfig = createBaseAgent({ maxTokens: SPECIALIST_MAX_TOKENS,
  id: "sf-agentforce",
  name: "Agentforce Design Specialist",
  role: "Agentforce Design Specialist",
  sections: {
    persona: _sec("Role"),
